...
//        String url = "http://data.uniondrug.cn/api/users/login";
//        HashMap<String, String> params = new HashMap<String, String>();
//        params.put("mobile", "15250989839");
//        params.put("password", "111111");
//        //BasicHeader header=new BasicHeader("User-Agent", "UnionDrug");
//        HashMap<String, String> header = new HashMap<String, String>();
//        header.put("User-Agent", "UnionDrug");
//
//        System.out.println(HttpClientUtil.post(url, params, header, null));
//    }
}